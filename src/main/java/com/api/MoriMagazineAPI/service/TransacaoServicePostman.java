...
public class TransacaoServicePostman {
    ...
    public Optional<TransacaoEntity> getTransacaoById(Integer id) { // Ajuste para Integer
        logger.debug("Buscando transação com ID: {}", id);
        return transacaoRepository.findById(id);
    }

    @Transactional
    public TransacaoEntity criarTransacao(TransacaoEntity transacao, Integer clienteId) {  // Ajuste para Integer
        logger.debug("Criando transação para o cliente ID: {}", clienteId);
    ...
    public TransacaoEntity atualizarTransacao(Integer id, TransacaoEntity transacaoAtualizada) { // Ajuste para Integer
    ...
    public void deletarTransacao(Integer id) { // Ajuste para Integer
        logger.debug("Deletando transação com ID: {}", id);
        transacaoRepository.deleteById(id);
    }

    private void validarCliente(Integer clienteId) {  // Ajuste para Integer
    ...
    private void associarClienteATransacao(TransacaoEntity transacao, Integer clienteId) {  // Ajuste para Integer
